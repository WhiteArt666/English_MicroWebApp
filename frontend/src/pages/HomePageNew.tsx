          ...
          <div>
            ...
            <RPGPanel title="Quick Start" variant="default">
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px' }}>
                <Link to="/lessons">
                  <RPGButton variant="primary" size="large" icon="fa300">
                    Start Learning
                  </RPGButton>
                </Link>
                <Link to="/game">
                  <RPGButton variant="success" size="large" icon="fa301">
                    Play Games
                  </RPGButton>
                </Link>
                <Link to="/community">
                  <RPGButton variant="warning" size="large" icon="fa302">
                    Join Community
                  </RPGButton>
                </Link>
                <Link to="/profile">
                  <RPGButton variant="secondary" size="large" icon="fa303">
                    View Profile
                  </RPGButton>
                </Link>
              </div>
      ...
      <div className="rpg-header">
        <div style={{ textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', flexWrap: 'wrap' }}>
            <Link to="/register">
              <RPGButton variant="primary" size="large" icon="fa400">
                Start Adventure
              </RPGButton>
            </Link>
            <Link to="/login">
              <RPGButton variant="secondary" size="large" icon="fa401">
                Continue Journey
              </RPGButton>
            </Link>
          </div>
